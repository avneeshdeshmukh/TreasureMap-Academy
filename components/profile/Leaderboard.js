export default function Leaderboard() {
    const playersTop5 = [
        { rank: 1, name: "Player1", coins: 500, streak: "20/20", avatar: "/images/solo4.png" },
        { rank: 2, name: "Player2", coins: 450, streak: "18/20", avatar: "/images/solo2.png" },
        { rank: 3, name: "Player3", coins: 400, streak: "17/20", avatar: "/images/solo3.png" },
        { rank: 4, name: "Player4", coins: 350, streak: "15/20", avatar: "/images/solo4.png" },
        { rank: 5, name: "Player5", coins: 300, streak: "10/20", avatar: "/images/solo1.png" },
    ];

    const playersTop10 = [
        { rank: 6, name: "Player6", coins: 250, streak: "10/20", avatar: "/images/solo1.png" },
        { rank: 7, name: "Player7", coins: 200, streak: "8/20", avatar: "/images/solo3.png" },
        { rank: 8, name: "Player8", coins: 150, streak: "5/20", avatar: "/images/solo2.png" },
        { rank: 9, name: "Player9", coins: 100, streak: "2/20", avatar: "/images/solo4.png" },
        { rank: 10, name: "Player10", coins: 50, streak: "1/20", avatar: "/images/solo1.png" },
    ];
    ...
    return (
        <div className="flex justify-center">
            <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg mt-8 max-w-3xl w-full">
                ...
                {/* Section for Top 5 */}
                <h4 className="text-xl font-semibold mb-2">Top 5 Pirates</h4>
                ...
                {/* Section for Top 10 */}
                <h4 className="text-xl font-semibold mb-2">Top 10 Pirates</h4>
                <div className="grid grid-cols-4 gap-4 text-center border-b border-gray-600 pb-2">
                    <p className="font-semibold">Rank</p>
                    <p className="font-semibold">Player</p>
                    <p className="font-semibold">Coins</p>
                ...
                <h4 className="text-xl font-semibold mb-2">Adventurers</h4>
                <div className="grid grid-cols-4 gap-4 text-center border-b border-gray-600 pb-2">
                    <p className="font-semibold">Rank</p>
                    <p className="font-semibold">Player</p>
                    <p className="font-semibold">Coins</p>
